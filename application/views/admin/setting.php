...
<div class="page animsition">
    <div class="page-header">
      	<h1 class="page-title">
			...
			if(isset($mode) && $mode=="edit") echo "Edit settings: ".$q['title'];
			else echo "Add settings";
			?>
		</h1>
      	<ol class="breadcrumb">
      	...
      	<div class="panel">
	        <div class="panel-body">
	          <form id="exampleFullForm" autocomplete="off" enctype="multipart/form-data" method="post" action="
	          	<?php
		  		if($mode != edit)echo BASEURL."admin/post_setting";
			  	else echo BASEURL."admin/update_setting";
		  		?>">
		  		<?php
	            ...
	            <div class="row row-lg">
	              	<div class="col-lg-12 form-horizontal">
						<div class="form-group form-material">
							<label class="col-lg-12 col-sm-3 control-label">Affiliate Profit (%)
								<span class="required">*</span>
							</label>
							<div class="col-lg-12 col-sm-9">
								<input type="text" class="form-control" name="profit" placeholder="Affiliate Profit %" required value="<?=$q['profit']?>">
							</div><!-- /12 -->
						</div><!-- /form-group -->
