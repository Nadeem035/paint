...
<div class="page animsition">
    <div class="page-header">
      	<h1 class="page-title">
			...
			if(isset($mode) && $mode=="edit") echo "Edit Worker: ".$q['title'];
			else echo "Add Worker";
			?>
		</h1>
      	<ol class="breadcrumb">
	        <li><a href="<?=BASEURL?>admin">Admin</a></li>
            <li><a href="<?=BASEURL?>admin/worker">Workers</a></li>
            <li>Add Worker</li>
      	</ol>
      	...
      	<div class="panel">
	        <div class="panel-body">
	          <form id="exampleFullForm" autocomplete="off" enctype="multipart/form-data" method="post" action="
	          	<?php
		  		if($mode != edit)echo BASEURL."admin/post_worker";
			  	else echo BASEURL."admin/update_worker";
		  		?>">
		  		<?php
	            ...
	            <div class="row row-lg">
	              	<div class="col-lg-12 form-horizontal">
						<div class="form-group form-material">
							<label class="col-lg-12 col-sm-3 control-label">Worker Name
