...
<div class="page animsition">
    <div class="page-header">
      	<h1 class="page-title">
			...
			if(isset($mode) && $mode=="edit") echo "Edit Slide: ";
			else echo "Add Slide ";
			?>
		</h1>
      	<ol class="breadcrumb">
	        <li><a href="<?=BASEURL?>admin">Admin</a></li>
            <li><a href="<?=BASEURL?>admin/slider">Slider</a></li>
            <li>Add Slide</li>
      	</ol>
      	...
      	<div class="panel">
	        <div class="panel-body">
	          <form id="exampleFullForm" autocomplete="off" enctype="multipart/form-data" method="post" action="
	          	<?php
		  		if($mode != edit)echo BASEURL."admin/post_slide";
			  	else echo BASEURL."admin/update_slide";
		  		?>">
		  		<?php
	            ...
	            <div class="row row-lg">
	              	<div class="col-lg-12 form-horizontal">
						<div class="form-group form-material">
							...
							<div class=" col-lg-12 col-sm-9">
								<input type="text" class="form-control" name="link" placeholder="Slide Link" value="<?=$q['link']?>">
							</div><!-- /12 -->
						</div><!-- /form-group -->
		                <div class="example-wrap">
							<h4 class="example-title">Slide (1600 X 800)</h4>
							<div class="example">
	              	...
	              	<div class="form-group form-material col-lg-12 text-right padding-top-m">
	                	<button type="submit" disabled="disabled" class="btn btn-primary" id="validateButton1">Submit</button> <a class="btn btn-danger waves-effect waves-light" href="<?=BASEURL?>admin/slider" class="cancel">Cancel</a>
	              	</div><!-- /form-group -->
	            </div><!-- /row/row-lg -->
	          </form>
	        </div><!-- /panel-body -->
