...
function del_q(cid) {
	...
	if (cnfr) {
		document.location = "<?=BASEURL?>worker/delete_lead?lead_id=" + cid;
	}
}
</script>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="margin-bottom-15">
                            <button id="addToTable" class="btn btn-primary" type="button" onClick="document.location='<?=BASEURL?>worker/add_lead';">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    ...
    <form action="<?=BASEURL?>worker/assign-package" method="post"> 
