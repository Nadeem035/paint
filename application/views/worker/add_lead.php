...
<div class="page animsition">
    <div class="page-header">
      	...
      	<ol class="breadcrumb">
            ...
            <li><a href="<?=BASEURL?>worker/lead">Leads</a></li>
            <li>Add Lead</li>
      	</ol>
      	...
      	<div class="panel">
	        <div class="panel-body">
	          <form id="exampleFullForm" autocomplete="off" enctype="multipart/form-data" method="post" action="
	          	<?php
		  		if($mode != edit)echo BASEURL."worker/post_lead";
			  	else echo BASEURL."worker/update_lead";
		  		?>">
		  		<?php
	            ...
	            <div class="row row-lg">
		            ...
		            <?php endif ?>
	              	<div class="form-group form-material col-lg-12 text-right padding-top-m">
	                	...
	                	<a class="btn btn-danger waves-effect waves-light" href="<?=BASEURL?>worker/cat" class="cancel">Cancel</a>
	              	</div><!-- /form-group -->
	            </div><!-- /row/row-lg -->
	          </form>
	        </div><!-- /panel-body -->
