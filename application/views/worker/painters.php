...
function del_q(cid) {
	...
	if (cnfr) {
		document.location = "<?=BASEURL?>worker/delete_painter?painter_id=" + cid;
	}
}
</script>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="margin-bottom-15">
                            <button id="addToTable" class="btn btn-primary" type="button" onClick="document.location='<?=BASEURL?>worker/add_painter';">
                        ...
                        if (count($painters) > 0) {
                            foreach ($painters as $q): ?>
                                <tr>
                                    ...
                                    <td><?=$q['status']?></td>
                                    <td class="actions">
                                        <a href="<?=BASEURL?>worker/edit_painter?id=<?=$q['painter_id']?>" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"
